                        ...
                        <tbody class="text-gray-800 dark:text-gray-300 text-sm font-light">
                            @foreach ($clientes as $cliente)
                                <tr
                                    ...
                                    <td class="py-4 px-6">{{ $cliente->name }}</td>
                                    ...
                                    <td class="py-4 px-6">{{ number_format($cliente->importe_cuota_mensual, 2) }}
                                        {{ $cliente->moneda }}
                                    </td>
                                    <td class="py-4 px-6 text-center">
                                        <div class="flex justify-center gap-4">
                                            ...
                                            <!-- Botón Editar -->
                                            <a href="{{ route('clientes.edit', ['cliente' => $cliente, 'page' => request('page', 1)]) }}"
